...
public class AirportClientTestClientConfig {
	...
	private static void getPassengers() {
		...
		String responsePassengersList = service.path("getAirport").request(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON).get(String.class);

		List<Airport> passengers = Arrays.asList(gson.fromJson(responsePassengersList, Airport[].class));
		System.out.println("\n Output JSON from Server getAirports .... \n");
		for (Airport p : passengers) {
