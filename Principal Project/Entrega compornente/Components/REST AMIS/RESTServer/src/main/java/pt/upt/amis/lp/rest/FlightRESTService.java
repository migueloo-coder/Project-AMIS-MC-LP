...
public class FlightRESTService {
	...
	@GET
	@Path("/getFlight/{idFlight}")
	public Response getFlight(@PathParam("idFlight") int idFlight) {
		Flight flightResponse = fls.findFlight(idFlight);
	...
	@DELETE
	@Path("/deleteFlight/{idFlight}")
	public Response deleteFlight(@PathParam("idFlight") int idFlight) {
		boolean flightRemoved = fls.removeFlight(idFlight);
